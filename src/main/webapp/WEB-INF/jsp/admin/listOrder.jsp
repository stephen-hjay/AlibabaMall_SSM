...
<script>
    $(function () {
        $("button.orderPageCheckOrderItems").click(function () {
            ...
            $("tr.orderPageOrderItemTR[oid=" + oid + "]").toggle(500);
        });

        $("#delivery").click(function () {
            var href = $(this).attr("_href");
            bootbox.confirm("确定发货?", function (result) {
                if (result) {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <c:if test="${o.status=='waitDelivery'}">
                            <a id="delivery" _href="/admin_order_delivery?id=${o.id}">
                                    ...
                                    <tr>
                                        <td align="left">
                                            <img width="120" height="120"
                                                 src="img/productSingle/${oi.product.firstProductImage.id}.jpg" data-action="zoom">
                                        </td>
                                        <td>
