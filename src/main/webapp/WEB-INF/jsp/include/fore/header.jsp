...
<head>
    ...
    <%--前端加密 AES：Advanced Encrytion Standard（高级加密标准）--%>
    <script src="/js/crypto/aes.js"></script>

    <script src="/js/utils/utils.js"></script>
    <script src="/js/utils/captcha.js"></script>
    ...
    <script>
        ...
        $(function () {
            ...
            $("div#footer a[href$=#nowhere]").click(function () {
                toastr.warning("模仿天猫的连接，并没有跳转到实际的页面");
            });

            $("a.wangwanglink").click(function () {
                toastr.warning("模仿旺旺的图标，并不会打开旺旺");
            });
            $("a.notImplementLink").click(function () {
                toastr.warning("这个功能没做，蛤蛤~");
            });
        });
    </script>
</head>
