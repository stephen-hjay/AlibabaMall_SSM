        ...
        $(".ask2delivery").click(function () {
            ...
            $.ajax({
                ...
                success: function (result) {
                    toastr.info("卖家已秒发，刷新当前页面，即可进行确认收货");
                }
            });
...
<div class="boughtDiv">
    <div class="orderType">
        ...
        <div><a orderStatus="finish" href="#nowhere" class="noRightborder">已评价</a></div>
            ...
            <table class="orderListItemTable" orderStatus="${order.status}" oid="${order.id}">
                ...
                <c:forEach items="${order.orderItems}" var="oi" varStatus="st">
                    <tr class="orderItemProductInfoPartTR">
                        <td class="orderItemProductInfoPartTD" style="width:120px;">
                        ...
                        <c:if test="${st.count==1}">
                            ...
                            <td valign="top" rowspan="${order.orderItems.size()}"
                                ...
                                <c:if test="${order.status=='waitPay' }">
                                    <a href="/foreAliPay?oid=${order.id}&total=${order.totalPrice}">
                                ...
                                <c:if test="${order.status=='waitReview' }">
                                    <a href="/foreReviewList?oid=${order.id}">
