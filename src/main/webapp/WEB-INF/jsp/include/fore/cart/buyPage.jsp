    ...
    <script>
        ...
        $(function () {
            $("#orderForm").submit(function () {
                return validOrderForm().form();
            });
        })
    </script>
    <form method="post" id="orderForm" action="/foreCreateOrder">
        <div class="buyFlow">
        ...
        <div class="productList">
            ...
            <div class="orderItemSumDiv">
                ...
                <span class="pull-right">店铺合计(含运费): ￥
					<fmt:formatNumber type="number" value="${total}" maxFractionDigits="2"/></span>
            </div>
        </div>
        ...
        <div class="submitOrderDiv">
            <button type="submit" class="submitOrderButton" id="submitOrderButton">提交订单</button>
        </div>
    </form>
</div>